...
\newcommand{\GetLocal}[1][\State]{|_{\mathtt{local},#1}\ }
\newcommand{\Program}[1][\State]{|_{\mathtt{prog},#1}\ }
\newcommand{\VReduces}[2][\State]{\ _{{#1},{#2}}\Reduces}
\newcommand{\Stopped}[1][\State]{|_{\mathtt{stop},#1}\ }
\newcommand{\Bind}[2][\State]{\ _{{#1},{#2}}|_{\mathtt{bind}}\ }
