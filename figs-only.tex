...
\frac{
  ...
  (\Time, \TName \colon \Nat + 1, \TNamey \colon 0, \Edges \cup \{((\TName,\Nat),(\TNamey,0)), (((\TName,\Nat),(\TName,\Nat+1))) \})
}
\\
\frac{
  \Time(\TName) \mapsto \Nat
  ...
  (\Time, \TName \colon \Nat + 1, \Edges \cup \{((\TNamey,\Naty),(\TName,\Nat)), (((\TName,\Nat),(\TName,\Nat+1)))\}
}
\\
\frac{
  \forall \TNamey, \Op \neq \FORCE \TNamey
